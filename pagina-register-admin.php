...
<body>
	...
	<input type="radio" name="permisos" value="Ad"> Admin </input>
	<input type="radio" name="permisos" value="Us"> Usuario </input>
	...
	<p>
	<a href="pagina-rutas.php" style="text-align: center;"> Regresar </a>
